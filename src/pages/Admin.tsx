...
import { Dashboard } from "../components/admin/adminComponent/Dashboard";
import { Documents } from "../components/admin/adminComponent/Documents";
import { SROICalculator } from "../components/admin/adminComponent/SROICalculator";
import { UserManagement } from "../components/admin/adminComponent/UserManagement";
import { Profile } from "../components/user/userComponent/Profil";
...
export default function Admin() {
	...
	const renderMainContent = () => {
		...
		switch (currentSection) {
			...
			case "documents":
				return (
					<Documents language={currentLanguage} userRole={currentUser?.role} />
				);
	...
	const renderSidebar = () => {
		if (currentUser?.role === "admin") {
			return <AdminSidebar responsiveSidebar={responsiveSidebar} />;
		} else {
			return <UserSidebar responsiveSidebar={responsiveSidebar} />;
		}
	};
